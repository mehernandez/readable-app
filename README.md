...
The Readable App, is a web application developed in ReactJS to manage posts realated to everything you read.

Just follow the instructions to start the API Server and the Front End Server.
